...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = // 'pk.eyJ1IjoidGhlcGhlbm9tZW5hbCIsImEiOiJjazhnbmtnYWMwMnNyM3FwZWt5dTYxOXRuIn0.ZmULmQOODizASmTiW_VI4g';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //extends the map bounds to include the cuurent location
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'error logged out, please try again');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"../../node_modules/base64-js/index.js":[function(require,module,exports) {
'use strict'
